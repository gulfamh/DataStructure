...
public class AVLTree {
    ...
    public BinaryNode deleteNodeOfBST(BinaryNode currentNode, int value) {
        ...
        if (value < currentNode.getValue()) {
            ...
            if (currentNode.getLeft() != null
                    && currentNode.getRight() != null) { // if nodeToBeDeleted have both children
                ...
                deleteNodeOfBST(currentNode.getRight(),
            ...
            return currentNode;// if it is a leaf node,then no need to do balancing for this node, do only for its
			// ancestors
        }
